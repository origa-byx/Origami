...
public class OriConstraintLayout extends ConstraintLayout implements OriViewGroup {
    ...
    public OriConstraintLayout(Context context) {
        super(context);
    }

    public OriConstraintLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OriConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
