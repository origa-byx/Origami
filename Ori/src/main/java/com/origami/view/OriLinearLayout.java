...
public class OriLinearLayout extends LinearLayout implements OriViewGroup {
    ...
    public OriLinearLayout(Context context) {
        super(context);
    }

    public OriLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OriLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
