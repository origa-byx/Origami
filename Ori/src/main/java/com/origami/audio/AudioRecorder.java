...
public class AudioRecorder {
    ...
    public interface RecordStreamListener{
        void recordOfByte(byte[] buffer, int offset, int length);
    }
    ...
    static class FileUtil{
        public static String getPcmFileAbsolutePath(String fileName){
            String path = App.appContext.getCacheDir().getPath() + File.separator + "pcm" + File.separator + fileName;
        ...
        public static String getWavFileAbsolutePath(String fileName) {
            String path = App.appContext.getCacheDir().getPath() + File.separator + "wav" + File.separator + fileName;
            File file = new File(path);
            if(file.getParentFile() != null && !file.getParentFile().exists()){ file.mkdirs(); }
            if(!file.exists()){
                try {
